      ...
      <div class="content">
        <div class="account-sidebar">
          <div class="avatar gray-box ">
            <div>
              <img :src="isNotBlank(userInfo)&&isNotBlank(userInfo.info)&&isNotBlank(userInfo.info.photo)?getFullUrl(userInfo.info.photo):''" > <h5>
              {{getUserName()}}</h5></div>
            <div class="box-inner">
...
<script>
  ...
  import { getStore, isNotBlank, getFullUrl} from "/utils/storage";
  export default {
    data () {
      return {
        title: '我的订单',
        nav: [
          ...
          {name: '我的询价', path: 'coupon'},
          // {name: '售后服务', path: 'support'},
          {name: '我的对账', path: 'aihuishou'}
        ],
        editAvatar: true
      }
    },
